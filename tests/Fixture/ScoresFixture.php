...
class ScoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'score' => ['type' => 'integer', 'length' => 50, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public $records = [
        [
            ...
            'user_id' => 1,
            'score' => 1,
            'expired' => '2021-02-25 09:27:39',
            'del_flg' => 'Lorem ipsum dolor sit amet',
            'created' => '2021-02-25 09:27:39',
            'modified' => '2021-02-25 09:27:39'
        ],
    ];
}
