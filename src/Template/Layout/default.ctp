...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="http://localhost/PRS/css/materialize.min.css" media="screen,projection" />
    <!-- <script src="https://code.jquery.com/jquery-3.5.1.min.js"></script> -->
    <script type="text/javascript" src="http://localhost/PRS/js/jquery-3.5.1.min.js"></script>
...
<body>
    ...
    <script type="text/javascript" src="http://localhost/PRS/js/materialize.min.js"></script>
</body>
